...
if (isset($_POST['payment'])) {
    $signup_query = mysqli_query($conn, "select firstname,lastname,contact,address from signup where id = " . $user_id);
    ...
    $select = mysqli_query($conn, "select * from cart where user_id = " . $user_id) or die('query 
    failed');
