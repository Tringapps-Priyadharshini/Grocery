<?php
 ...
 $unit = $_POST['unit'];
 $select_cart = mysqli_query($conn,"select * from `cart` where productname = '$productName' and user_id = '$user_id' ") or die('query failed'); 
...
echo('<script>alert("product added to cart")</script>');
 ...
 <?php
 $select = mysqli_query($conn,"select * from add_product where category = 'rice'"); 
