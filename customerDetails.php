...
if(isset($_POST['next'])){
    ...
    echo $date;
    mysqli_query($conn,"insert into `customerdetails`(user_id,firstname,lastname,contact,address,date)values('$id','$fname','$lname','$contact','$address','$date')") or die("query failed");
